						...
						<div class="row no-gutters">
							<div class="col-md-7 d-flex align-items-stretch">
								<div  class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">التعديل</h3>
									<div id="form-message-warning" class="mb-4"></div> 
									<form method="POST" action = "/update/contact/{{$edit->id}}" enctype="multipart/form-data" id="contactForm" name="contactForm">
                                            @csrf	
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Notice</label>
                                                <input type="text" class="form-control" name="notice" id="notice" value="{{$edit->notice}}" >
                                            </div>
                                        </div>
