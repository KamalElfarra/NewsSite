                    ...
                    <div class="col-lg-8">
                        <div class="sn-container">
                            ...
                            <div class="sn-content">
                                <h3 class="sn-title" style = "text-align:right">{{$info->title}}</h3>
                                <p  style = "text-align:right">

                                    {{ $info->content}}

                                </p>
                                <p style = "text-align:right; margin-right:1%;">{{$info->created_at->todatestring()}}</p>
                            ...
                            @foreach($related as $data)
                                <div class="col-md-4">
                                        <div class="sn-img">
                                            <img src="/{{$data->photo}}" />
                                            <div class="sn-title">
                                                <a href="/info/technology/{{$data->id}}">{{$data->title}}</a>
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="news-list">
                                    ...
                                    <div class="sn-container">
                                        <div class="sn-content" style = "text-align:right; margin-right:5%;">
                                            <a href = "/info/technology/{{$data->id}}" target = "_blank"><h5 class="sn-title" style = "width:250px; margin-left:45%; margin-top:2%; text-align:right;">{{$data->title}}</h5></a>
                                        </div>
                                        <p  style = "text-align:right; width:70%">
                                                {!! nl2br(substr($data->content,0,200))  !!}
                                        </p>
                                     <p style = "text-align:right; margin-right:1%;">{{$data->created_at->todatestring()}}</p>

                                    </div>
                                    <div>
                                            <img src="/{{$data->photo}}" style = "width:200px; height:300px; margin-top:-110%; margin-left:-140px;   padding-top: 85px; " /> 
                                    </div>
