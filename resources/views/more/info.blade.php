...
<html lang="en">
    ...
    <body>
        ...
        <div class="breadcrumb-wrap">
            <div class="container">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" style = "margin-right:45%">{{__("message.News details")}}</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sn-container">
                            <div class="sn-img">
                                <img src="/{{$get_id->photo}}" style = "width:100%; height:500px;"/>
                            </div>
                            <div class="sn-content">
                                <h1 class="sn-title" style = "text-align:right">{{$get_id->title}}</h1>
                                <p style = "text-align:right">

                                    {{$get_id->content}}

                                </p>
                                <p style = "text-align:right">{{$get_id->created_at->todatestring()}}</p>
                            </div>
                        </div>
                            ...
                            <div class="sidebar-widget">
                                <div class="news-list">
                                    ...
                                    <div class="sn-container">
                                        ...
                                        <p  style = "width:75%; margin-right:3%; text-align:right;">
