                ...
                <div class="card" style = "height:650px;">
						<div class="card  box-shadow-0">
							...
							<div class="card-body pt-0">
								<form method = "POST" action = "/store/more" enctype="multipart/form-data" class="form-horizontal" >
                                    @csrf
									...
									<div class="form-group col-md-4">
                                        ...
                                        <select id="inputState" class="form-control" name = "type_id" style = "width:100%; margin-right:-1%">
                                            <option selected>Choose...</option>
