                    ...
                    <div class="col-lg-8">
                        <div class="sn-container">
                            ...
                            <div class="sn-content">
                                <h3 class="sn-title">{{$info->title}}</h3>
                                <p>
                            ...
                            @foreach($related as $data)
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        <img src="/{{$data->photo}}" />
                                        <div class="sn-title">
                                            <a href="/info/sport/{{$data->id}}">{{$data->title}}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="news-list">
                                    ...
                                    <div class="sn-container">
                                        <div style = "text-align:right; margin-right:5%; ">
                                            <a href = "/info/sport/{{$data->id}}" target = "_blank"><h5 class="sn-title" style = "width:80%; margin-left:45%; margin-top:15%; text-align:right">{{$data->title}}</h5></a>
                                        </div>
                                        <p style = "margin-left:90%; width:70%; text-align:right ">{!! nl2br(substr($data->content,0,210)) !!}</p>
                                        <p style = "text-align:right">{{$data->created_at->todatestring()}}</p>

                                        <br>
                                    </div>
                                    <div>
                                            <img src="/{{$data->photo}}" style = "width:200px; height:250px; margin-top:-115%; margin-left:-150px;   padding-top: 85px; " /> 
                                    </div>
