...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="/single_page/sport" class="nav-item nav-link active">{{__('message.Sports')}}</a>
        ...
        <div class="breadcrumb-wrap">
            <div class="container">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" style = "margin-right:50%">{{__("message.sport")}}</li>
                </ul>
            </div>
        </div>
                    ...
                    @foreach($sport as $data)
                        <div class="sn-container">
                            <div class="sn-content" style = "text-align:right; margin-right:5%; margin-top:8%;">
                                <a href = "/info/sport/{{$data->id}}" target = "_blank"><h4 class="sn-title" style = "width:300px; margin-left:45%; margin-top:2%; text-align:right">{{$data->title}}</h4></a>
                                <p style = "text-align:right; width:50%;">{!! nl2br(substr($data->content,0,210)) !!}</p>
                        ...
                        <div>
                                <img src="/{{$data->photo}}" style = "width:200px; height:300px; margin-top:-70%;   padding-top: 85px; " /> 
                        </div>
                    @endforeach
                ...
                <div class="col-md-6 tn-right" >
                    ...
                    <div class="sn-container">
                            ...
                            <div class="sn-content">
                             <a href = "/info/sport/{{$latest->id}}" target = "_blank"><h4 class="sn-title" style = "margin-left:-18%; margin-right:3%; text-align:right" >{{$latest->title}}</h4></a> 
                                <p style = " margin-right:5%; width:100%; text-align:right">

                                {{  substr($latest->content,0,210) }}
            ...
            <div class="container">
                ...
                <div class="col-md-6" >
                    ...
                    <div class="sn-container">
                            ...
                            <br>
                            <div class="sn-content">
                                <a href = "/info/sport/{{$data->id}}"> <h4 class="sn-title" style = "width:600px; text-align:right; margin-left:107%">{{$data->title}}</h4></a>
                                <p  style = "width:600px; margin-right:3%; text-align:right;">
