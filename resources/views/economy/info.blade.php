...
<html lang="en">
    ...
    <body>
        ...
        <div class="breadcrumb-wrap">
            <div class="container">
                <ul class="breadcrumb">
                <li class="breadcrumb-item active" style = "margin-right:45%">{{__("message.economy")}}</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                    ...
                    <div class="col-lg-8">
                        <div class="sn-container">
                            ...
                            <div class="sn-content">
                                ...
                                <p style = "text-align:right; margin-right:2%;">{{$info->created_at->todatestring()}}</p>
                            ...
                            @foreach($related as $data)
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        <img src="/{{$data->photo}}" />
                                        <div class="sn-title">
                                            <a href="/info/economy/{{$data->id}}">{{$data->title}}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="news-list">
                                    ...
                                    <div class="sn-container">
                                        <div class="sn-content" style = "text-align:right; margin-right:5%;">
                                            <a href = "/info/economy/{{$data->id}}" target = "_blank"><h5 class="sn-title" style = "width:250px; margin-left:45%; margin-top:2%">{{$data->title}}</h5></a>
                                        </div>
                                        <p  style = "width:80%; margin-left:107%; text-align:right">
                                        ...
                                        <br>
                                        <div>
                                            <img src="/{{$data->photo}}" style = "width:200px; height:300px; margin-top:-110%; margin-left:-150px;   padding-top: 85px; " /> 
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
