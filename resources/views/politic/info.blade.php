                            ...
                            @foreach($related as $data)
                                <div class="col-md-4">
                                    <div class="sn-img">
                                        <img src="/{{$data->photo}}" />
                                        <div class="sn-title">
                                            <a href="/info/politic/{{$data->id}}">{{$data->title}}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="news-list">
                                    ...
                                    <div class="sn-container">
                                        ...
                                        <p  style = "width:80%; margin-left:107%; text-align:right">
                                             {!! nl2br(substr($data->content,0,166)) !!}
                                         </p>
                                    ...
                                    <div>
                                            <img src="/{{$data->photo}}" style = "width:200px; height:300px; margin-top:-100%; margin-left:-160px;   padding-top: 85px; " /> 
                                    </div>
